# ARCHIVUM — index memoriae communis
...
**Claude: 13 sessiones, 39 Mo rudia -> 1883 Ko excerpta (5 %).**
...
|---|---|---:|
| [2026-08-23 — Compilator dynamicus et synchronisation Windows](CHATGPT-2026-08-23-compilator-dynamicus.md) | communicatio publica | 2 Ko |
| [2026-08-23 — Purificatio VINDEX 0.53](CHATGPT-2026-08-23-vindex-053-purificatio.md) | communicatio publica | 2 Ko |
| [2026-08-24 — Sylvia Laboratorium : bureau, texte et souris UEFI](CHATGPT-2026-08-24-sylvia-laboratorium-visuel.md) | communicatio publica | 3 Ko |
| [2026-08-26 — P9 : documentation canonique et bibliothèque standard](CHATGPT-2026-08-26-p9-documentatio-bibliotheca.md) | communicatio publica | 3 Ko |
| [2026-08-29 — Graphica X : P16-XII A à E](CHATGPT-2026-08-29-graphica-x-p16-xii-a-e.md) | reconstructio | 2 Ko |
| [2026-08-30/09-02 — Backend Graphica X et P12 matériel](CHATGPT-2026-08-30-2026-09-02-backend-gpu-p12.md) | reconstructio | 2 Ko |
...
- `extrahe_archivum.py` — sessiones Claude in hoc directorio regenerat atque hunc indicem reficit, inscriptionibus ChatGPT intactis.
- `verifica_secreta.py` — formas secretorum manifestas in fasciculis Markdown archivi recusat.

Conventio canonica igitur est: **unum tantum directorium `ARCHIVUM/` in radice; omnis reliqua memoria communis intus manet.**
